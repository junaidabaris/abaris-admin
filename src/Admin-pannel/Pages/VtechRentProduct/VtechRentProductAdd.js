...
function VtechRentProductAdd() {
    ...
    const toastSuccessMessage2 = () => {
        toast.success("Rent Product Add Successfully", {
            position: "top-center"
        })
    };

    const toastErrorMessage2 = () => {
        toast.error("Rent Product Not Added", {
            position: "top-center"
        })
    };
            ...
            <div className="aiz-main-content">
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <h5 className="mb-0 h6">Add New Rent Product</h5>
                    </div>
                    <div className>
                        {/* Error Meassages */}
...
export default VtechRentProductAdd;