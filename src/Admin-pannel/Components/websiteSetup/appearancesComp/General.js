        ...
        <>
            <div className="card">
                ...
                <div className="card-body">
                    <form action="https://mmslfashions.in/admin/business-settings/update" method="POST">
                        <input type="hidden" name="_token" defaultValue="MfWj9eEof7fNq0mKB42pyG49sPDPkHAVyVSS7UBT" />                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                <input type="hidden" name="types[]" defaultValue="website_name" />
                                <input type="text" name="website_name" className="form-control" placeholder="Website Name" defaultValue="ETG - a global conglomerate with diverse expertise encompassing the full supply chain" fdprocessedid="t2ds68j" />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-md-3 col-from-label">Site Motto</label>
                            <div className="col-md-8">
                                <input type="hidden" name="types[]" defaultValue="site_motto" />
                                <input type="text" name="site_motto" className="form-control" placeholder="Best eCommerce Website" defaultValue="A global conglomerate with diverse expertise encompassing the full supply chain" fdprocessedid="1rmaqv" />
                            </div>
                        </div>
                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                <div className="input-group " data-toggle="aizuploader" data-type="image" onClick={handleShow}>
                                    ...
                                    <input type="hidden" name="types[]" defaultValue="site_icon" />
                                    <input type="hidden" name="site_icon" defaultValue={5} className="selected-files" />
                                </div>
                                <div className="file-preview box"><div className="d-flex justify-content-between align-items-center mt-2 file-preview-item" data-id={5} title="favicon-32x32.png"><div className="align-items-center align-self-stretch d-flex justify-content-center thumb"><img src="https://mmslfashions.in/public/uploads/all/qWtVvdVrkexRR41VVaNV6W7yzjMGUVrD3HqfnYNA.png" className="img-fit" /></div><div className="col body"><h6 className="d-flex"><span className="text-truncate title">favicon-32x32</span><span className="ext flex-shrink-0">.png</span></h6><p>2 KB</p></div><div className="remove"><button className="btn btn-sm btn-link remove-attachment" type="button" fdprocessedid="6tnt4"><i className="la la-close" /></button></div></div></div>
                                <small className="text-muted">Website favicon. 32x32 .png</small>
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                <input type="hidden" name="types[]" defaultValue="base_color" />
                                <input type="text" name="base_color" className="form-control" placeholder="#377dff" defaultValue="#e62e04" fdprocessedid="74zdr" />
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-md-8">
                                <input type="hidden" name="types[]" defaultValue="base_hov_color" />
                                <input type="text" name="base_hov_color" className="form-control" placeholder="#377dff" defaultValue="#e62e04" fdprocessedid="zhpbt" />
                                <small className="text-muted">Hex Color Code</small>
                            </div>
                        </div>
                        <div className="text-right">
                            <button type="submit" className="btn btn-primary" fdprocessedid="nl9ds4">Update</button>
                        </div>
                    </form>
                </div>
            </div>
