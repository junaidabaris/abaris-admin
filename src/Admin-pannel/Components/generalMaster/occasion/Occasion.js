...
function Occasion() {
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/occasion/delete_occasion/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Occasion</h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-occasion" className="btn btn-circle btn-info">
