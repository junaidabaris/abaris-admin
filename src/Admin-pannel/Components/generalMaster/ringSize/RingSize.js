...
function RingSize() {
    ...
    const deletData = async (id) => {
        try {
            const res = await axios.delete(`https://onlineparttimejobs.in/api/ringSize/delete_ringsize/${id}`, {
                headers: {
                    "Content-type": "application/json; charset=UTF-8",
                    Authorization: `Bearer ${token}`,
                },
                ...
                <div className="px-15px px-lg-25px">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Ring Size </h5>
                            <div className="col-md-6 text-md-right">
                                <Link to="/admin/add-ring-size" className="btn btn-circle btn-info">
                                    <span>Add Ring Size</span>
                                </Link>
                            </div>
                        </div>
