        ...
        <>
            <div className="container">
                <div className="scheduler-border">
                    <legend className="scheduler-border">Site Configuration</legend>
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="form-group">
                                <label htmlFor="site_name">Site Name *</label>
                                <input type="text" name="site_name" className="form-control tip" id="site_name" required="required" />
                            </div>
                        </div>
                        <div className="col-lg-4">
                        ...
                        <div className="col-lg-4">
                            ...
                            <select name="customer_group" className="form-select" >
                        ...
                        <div className="col-lg-4">
                            <label htmlFor="site_name">Date Format *</label>
                            <input type="date" className="form-control tip" />
                        </div>
                        <div className="col-lg-4">
                ...
                <div className="scheduler-border">
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select" >
                                <option value={0} selected="selected">Y es</option>
                        ...
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select" >
                                <option value={0} selected="selected">Sequence Number</option>
                                <option value={1} >Random Number</option>
                            </select>
                        </div>
                        <div className="col-lg-4">
                        ...
                        <div className="col-lg-4">
                            ...
                            <input type="number" className="form-control tip" />
                        </div>
                        <div className="col-lg-4">
                            <label htmlFor="site_name">Cart Item Addition Method *</label>
                            <select name="rows_per_page" id="rows_per_page" className="form-select">
                                <option value={0} >Add New Item to cart</option>
                                <option value={1} selected="selected">Increase item quantity, if it already exists in cart</option>
                            </select>
                        </div>
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select">
                                ...
                                <option value={1} selected="selected">Quantity input for last order item</option>
                            </select>
                        </div>
                        <div className="col-lg-4">
                ...
                <div className="scheduler-border">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select">
                                <option value={0} >Remove expired products from stock</option>
                                <option value={1} selected="selected">Yes, remove from stock automatically</option>
                            </select>
                        </div>
                        <div className="col-lg-4">
                        ...
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select">
                                <option value={0} >Hide with 0 quantityy</option>
                        ...
                        <div className="col-lg-4">
                            ...
                            <select name="rows_per_page" id="rows_per_page" className="form-select">
                                ...
                                <option value={1} selected="selected">SVG</option>
                            </select>
                        </div>
                        <div className="col-lg-4">
                ...
                <button type="button" className="btn btn-primary btn-lg">Update Settings</button>
            </div>
        </>
    )
}
