                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="form-group">
                            ...
                            <input type="text" name="SiteName" value={inputVal?.SiteName} className="form-control tip" id="site_name" required="required" onChange={onChangeHandler} />
                        </div>
                    </div>
                    <div className="col-lg-4">
                    ...
                    {/* <div className="col-lg-4">
                        <label htmlFor="site_name">Maintenance Mode *</label>
                        <select name="customer_group" className="form-select" onChange={onChangeHandler}>
                    ...
                    <div className="col-lg-4">
                        ...
                        <input type="date" className="form-control tip" name='DateFormat' onChange={onChangeHandler} />
                    </div>
                    <div className="col-lg-4">
...
export default SystemSiteConfiguration