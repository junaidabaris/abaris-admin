        ...
        <div className="px-15px px-lg-25px">
            ...
            <div className="card">
                <div className="card-header">
                    <h5 className="mb-0 h6">  Asset Request List
                    </h5>
                    <div className="col-md-6 text-md-right">
                    ...
                    <table className="table table-3 position-relative">
                        <thead>
                            <tr>
                                ...
                                <th class="table-secondary" scope="col">Requested Employee</th>
                                <th class="table-secondary" scope="col">Approved By Employee</th>
                                <th class="table-secondary" scope="col">Status</th>
                                <th class="table-secondary" scope="col">Requested Date</th>
                                <th class="table-secondary" scope="col">Recived Date</th>
