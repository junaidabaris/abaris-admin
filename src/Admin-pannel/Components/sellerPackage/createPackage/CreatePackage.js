  ...
  <div className="px-15px px-lg-25px">
    <div className="col-lg-10 mx-auto">
      <div className="card">
        ...
        <form className="form-horizontal" action="https://mmslfashions.in/admin/seller_packages" method="POST" encType="multipart/form-data">
          <input type="hidden" name="_token" defaultValue="TyHfDPRv50PEr254yocX747AYVOzofV6mp8xMJ17" />                <div className="card-body">
            <div className="form-group row">
              <label className="col-sm-2 col-from-label" htmlFor="name">Package Name</label>
              <div className="col-sm-10">
                <input type="text" placeholder="Name" id="name" name="name" className="form-control" required fdprocessedid="wle4vm" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-sm-2 col-from-label" htmlFor="amount">Amount</label>
              <div className="col-sm-10">
                <input type="number" min={0} step="0.01" placeholder="Amount" id="amount" name="amount" className="form-control" required fdprocessedid="2fzobh" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-sm-2 col-from-label" htmlFor="product_upload_limit">Product Upload Limit</label>
              <div className="col-sm-10">
                <input type="number" min={0} step={1} placeholder="Product Upload Limit" id="product_upload_limit" name="product_upload_limit" className="form-control" required fdprocessedid="zpnue" />
              </div>
            </div>
            <div className="form-group row">
              <label className="col-sm-2 col-from-label" htmlFor="duration">Duration</label>
              <div className="col-sm-10">
                <input type="number" min={0} step={1} placeholder="Validity in number of days" id="duration" name="duration" className="form-control" required fdprocessedid="mazzs" />
              </div>
            </div>
            <div className="form-group row">
              ...
              <div className="col-md-10">
                <div className="input-group" data-toggle="aizuploader" data-type="image" data-multiple="false">
                  ...
                  <div className="form-control file-amount" onClick={handleShow}>Choose File</div>
