...
function DashboardAdminComp() {
  ...
  const getAllDeta = async () => {
    ...
    const activeCoupen = await axios.get(` http://onlineparttimejobs.in/api/coupons/active/count`)
    setactiveCoupen(activeCoupen.data)

    const coupens = await axios.get(` http://onlineparttimejobs.in/api/coupons/active/count`)
