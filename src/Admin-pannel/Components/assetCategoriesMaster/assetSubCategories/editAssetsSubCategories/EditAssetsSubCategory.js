...
function EditAssetsSubCategory() {
    ...
    const getSubAsetsId = async() => {
        const getByIdData = await axios.get(`${base_Url_Assets}assetSubCategories/${param.id}`)
    ...
    const editHandle = async() => {
        const responce = await axios.put(`${base_Url_Assets}assetSubCategories/update_assetSubCategoriess/${param.id}`,addAsset)
                ...
                <div className="px-15px px-lg-25px">
                    <div className="aiz-titlebar text-left mt-2 mb-3">
                        <div className="row align-items-center">
                            <div className="col-md-6">
                                <h1 className="h3">Edit Asset SubCategories</h1>
                            </div>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="mb-0 h6">Edit Asset SubCategories</h5>
                        </div>
                        <div className="card">
...
export default EditAssetsSubCategory