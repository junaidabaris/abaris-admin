...
export const productsApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // updateWeighingScale: builder.mutation({
        //     query: (payload) => ({
        //         url: '',
        //         method: 'PUT',
        //         body: payload,
        ...
        // updateMoneyAwardPoint: builder.mutation({
        //     query: (payload) => ({
        //         url: '',
        //         method: 'PUT',
        //         body: payload,
