...
import { useEditAttributeMutation, useGetAttributeByIdQuery } from '../all-products/allproductsApi/allProductsApi';
...
function EditAttribute() {
    ...
    const { data } = useGetAttributeByIdQuery(params.id);
    ...
    const submitEditAttributeData = (e) => {
        e.preventDefault();
        editAttribute({ id: params.id, data: inputval })
                    ...
                    <div className="col-lg-8 mx-auto">
                        <div className="card">
                            <div className="card-body p-0">
                                ...
                                <form className="p-4" id="create-course-form" onSubmit={submitEditAttributeData}>
