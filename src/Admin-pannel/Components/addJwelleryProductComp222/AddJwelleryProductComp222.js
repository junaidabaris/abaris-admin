...
function AddJwelleryProductComp222() {
    ...
    const onChangeHandlePrice = async (e, languageId, countryName) => {
        if (e.target.name == 'sale_rate') {
            const blankArr = []
            const maped1 = countryData.map((item, i) => {
