                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="form-group col-md-4">
                                                    <label className="col-md-12 col-from-label">Category Type<span className="text-danger">*</span></label>
                                                    <div id="category">
                                                        <Multiselect
                                                            isObject={true}
                                                            displayValue="name"
                                                            ...
                                                            showCheckbox
                                                            selectedValues={item?.categoryType}
                                                            onRemove={(selectedCat) => {
                                                                const selectedIds = selectedCat.map((cat) => {
                                                                    return cat.uid
                                                                })
                                                                setcategoryFinalType(selectedIds)
                                                            }}
                                            ...
                                            <div className="row">
                                                <div className="form-group col-md-4">
                                                    <label className="col-md-12 col-from-label">Sub Category<span className="text-danger">*</span></label>
                                                    <div id="category">
                                                        <Multiselect
                                                            isObject={true}
                                                            displayValue="name"
                                                            options={subCategoryListD}
                                                            showCheckbox
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="form-group col-md-4">
                                                    ...
                                                    <input type="number" className="form-control" name="grossWeight" value={item?.grossWeight} placeholder="Weight" required fdprocessedid="3bss68" onChange={(e) => { onChangeHandler(e, item.language_id) }} />
                                                </div>
                                        ...
                                        <div className="card-body">
                                            <div className="form-group row">
                                                <div className="form-group col-md-6">
                                                    <input type="number" className="form-control" name="carat" value={item?.carat} placeholder="Carat" required fdprocessedid="3bss68" onChange={(e) => { onChangeHandler(e, item.language_id) }} />
                                                </div>
                                                <div className="form-group col-md-6">
                                            ...
                                            {metalRowData?.map((val, i) => {
                                                return <div className="row mt-2" key={i}>
                                                    ...
                                                    <div className="col-lg-3">
                                                        ...
                                                        <select className="form-select" aria-label="Default select example" value={val?.metalType?._id ? val?.metalType?._id : val?.metalType} name="metalType" onChange={(e) => handleChangeMetal(e, i)}>
                                            ...
                                            {stoneRowData.map((val, i) => {
                                                return <div className="row mt-2" key={i}>
                                                    ...
                                                    <div className="col-md-3">
                                                        ...
                                                        <input className='form-control' name='carat' value={val?.carat?._id ? val?.carat?._id : val?.carat} type='number' placeholder='Carat' onChange={(e) => handleChangeStone(e, i)} />
                                                    </div>
                                                    <div className="col-md-2">
                                        ...
                                        <div className="card-body mt-4">
                                            {diamondRowData.map((val, i) => {
                                                return <div className="row mt-2">
                                                    ...
                                                    <div className="col-md-3">
                                                        <label className="col-md-12 col-from-label">Carat</label>
                                                        <input className='form-control' name='carat' value={val?.carat?._id ? val?.carat?._id : val?.carat} type='number' placeholder='Carat' onChange={(e) => handleChangeDiamond(e, i)} />
                                                    </div>
                                                    <div className="col-md-2">
                                                        <label className="col-md-12 col-from-label">Pieces</label>
